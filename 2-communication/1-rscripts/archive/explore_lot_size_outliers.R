...
inv_bldg_oversized %>% group_by(AREA_CAT_OUTLIER_FCT) %>% summarise(MAX = max(SUIT_PARCEL_AREA))

# # A tibble: 2 x 2
#   AREA_CAT_OUTLIER_FCT    MAX
#   <fct>                 <dbl>
# 1 OUTLIER              1324. 
# 2 NOT OUTLIER            27.5 <- seems like a reasonable threshold
...
mapview(inv_sf, zcol = "SUIT_PARCEL_AREA_OUTLIER")
