...
#### Processing Steps {-}
##### Summary {-}
  1.  Create `p`: a `tibble` containing parcel data.
  2.  Create `acct`: a `tibble` containing real property account data.
  3.  Create `p_sf`: a `simple feature` object containing the spatial polygon representations of each parcel in the dataset.
