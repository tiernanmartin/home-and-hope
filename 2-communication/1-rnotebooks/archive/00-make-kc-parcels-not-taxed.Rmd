...
<<<<<<< HEAD:2-communication/1-rnotebooks/archive/00-make-kc-parcels-not-taxed.Rmd
  5.  Create `tax_0_sf`: Join and filter the datasets.
=======
  5.  Create `pub_or_tax_exempt_sf`: Join and filter the datasets.
>>>>>>> 7691e2b841c31e40f2355b1a928d57e1cbbd8ba8:2-communication/1-rnotebooks/archive/00-make-kc-parcels-not-taxed.Rmd
